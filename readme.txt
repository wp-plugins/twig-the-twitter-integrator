...
* Fixed bug for servers that don't support short tags.
...
* Fixed issue with tweets from first posts page appearing on subsequent pages.

= 0.16 =

* Commented out CURLOPT_FOLLOWLOCATION in twitter.class.php.
* Fixed bug in twig-settings.php where form submission path was incorrect.

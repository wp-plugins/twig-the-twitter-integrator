...
<form action="options-general.php?page=twig/twig-settings.php" method="post" id="twig_admin_options" onsubmit="return twig_validateFields(this);">
    <table class="form-table">
        <tr valign="top">
            ...
            <td>
                <input type="text" name="twig_config_twitter_username" id="twig_config_twitter_username" value="<?=twig_get_settings('twig_config_twitter_username')?>" size="32" class="required" />
            </td>
        </tr>
        <tr valign="top">
            <th scope="row">
            ...
            <td>
                <input type="text" name="twig_config_twitter_password" id="twig_config_twitter_password" value="<?=twig_get_settings('twig_config_twitter_password')?>" size="32" class="required" />
    ...
    <table class="form-table">
        <tr valign="top">
            ...
            <td>
                <input type="text" name="twig_config_refresh_interval" id="twig_config_refresh_interval" value="<?=twig_get_settings('twig_config_refresh_interval')?>" size="4" class="required" /><br />
        ...
        <tr valign="top">
            ...
            <td>
                <input type="text" name="twig_config_tweet_limit" id="twig_config_tweet_limit" value="<?=twig_get_settings('twig_config_tweet_limit')?>" size="4" class="required" /><br />
        ...
        <tr valign="top">
            ...
            <td>
                <input type="text" name="twig_config_date_format" id="twig_config_date_format" value="<?=twig_get_settings('twig_config_date_format')?>" size="15" /> (<a href="http://us3.php.net/date" target="_blank">Formatting Reference</a>)
            </td>
        </tr>
        <tr valign="top">
            <th scope="row">
            ...
            <td>
                <input type="text" name="twig_config_tweet_filter" id="twig_config_tweet_filter" value="<?=twig_get_settings('twig_config_tweet_filter')?>" size="15" /> (Leave blank to show all Tweets)<br />
        ...
        <tr valign="top">
            ...
            <td>
                <input type="checkbox" name="twig_config_hide_replies" id="twig_config_hide_replies" value="1" <?=(twig_get_settings('twig_config_hide_replies') ? "checked" : "")?> />
        ...
        <tr valign="top">
            ...
            <td>
                <input type="checkbox" name="twig_config_prepend_username" id="twig_config_prepend_username" value="1" <?=(twig_get_settings('twig_config_prepend_username') ? "checked" : "")?> />
    ...
    <p><strong>Tweet Template:</strong><br /><textarea name="twig_config_template" id="twig_config_template" rows="7" wrap="off" style="width: 100%;"><?=twig_get_settings('twig_config_template')?></textarea><br />
		<span class="setting-description"><strong>Valid tags:</strong> (id}, {text}, {date}, {source}, {delete_button}, {unique_css_id}</span>
    </p>
    
    <p><strong>Show More/Hide Template (used if <tt>Tweet Limit</tt> is set):</strong><br /><textarea name="twig_config_show_template" id="twig_config_show_template" rows="4" wrap="off" style="width: 100%;"><?=twig_get_settings('twig_config_show_template')?></textarea><br />
